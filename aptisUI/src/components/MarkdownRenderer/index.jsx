...
const components = {
	...
	h2: ({ children }) => (
		<h2 className="text-lg md:text-lg lg:text-lg font-bold py-2">
			{children}
		</h2>
	),
	h3: ({ children }) => (
	...
	h4: ({ children }) => <h4 className="font-bold py-1">{children}</h4>,
	p: ({ children }) => (
	...
	ul: ({ children }) => (
		<ul className=" list-disc pl-2 marker:text-white-500 text-sm md:text-base text-white-600 dark:text-white-400">
			{children}
		</ul>
	),
	ol: ({ children }) => (
	...
	li: ({ children }) => (
		<li className="my-2 relative before:absolute before:left-[-1em] before:text-white-500 before:font-bold md:text-base text-white-600 dark:text-white-400">
			{children}
		</li>
	),
	strong: ({ children }) => (
