...
export default function FooterTest({
  ...
  return (
    <>
      <div className="footer-test z-50">
        <div className="flex items-center gap-1">
          {((currentExamPart !== "speaking" && currentExamPart !== "result") ||   isSpeakingTaiLieu) && (
          ...
          <IconBox onClick={openModalInfo}>
            <svg
              ...
              viewBox="0 0 24 24"
              stroke="currentColor"
              className="w-6 h-6 stroke-2 bg-black text-white rounded-full"
            >
                ...
                <div className="flex items-center gap-1">
                  <div>
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      className="w-6 h-6 stroke-2 mr-1"
                    >
