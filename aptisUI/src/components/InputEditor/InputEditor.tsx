...
export default function Editor({
  ...
  useEffect(() => {
    if ((checkType === 'des')) {
      setDes(rteRef.current?.editor?.getHTML())
    }
  }, [isStatusEditor])
    ...
    <>
      <Box
        sx={{
          ...
          height: hieghtInput ? hieghtInput : 'calc(100vh - 250px)',
          overflow: 'auto'
          // position: 'absolute',
          // top: 0,
          // zIndex:10000
          ...
          RichTextFieldProps={{
            ...
            footer: isShowFoter && (
              ...
              >
                ...
                />
                <Box sx={{ padding: '10px', border: '1px solid' }} onClick={onScaleSreen}>
                  Scale
                </Box>
