...
import {
  ...
  DialogHeader,
  DialogTitle
} from '@renderer/components/Calendar/ui/dialog'
...
const Calendar: React.FC = () => {
  ...
  //     console.log("savedEvents bla",savedEvents)
  //     if (savedEvents) {
  ...
  return (
    <div>
      <div className="flex w-full px-10 justify-start items-start gap-8 overflow-auto">
